...
{
    public class CreateAccessTokenQuery : IRequest<CreateAccesTokenViewModel>
    {
        ...
        public class Handler : IRequestHandler<CreateAccessTokenQuery, CreateAccesTokenViewModel>
        {
            ...
            public async Task<CreateAccesTokenViewModel> Handle(CreateAccessTokenQuery request, CancellationToken cancellationToken)
            {
                ...
                return new CreateAccesTokenViewModel()
                {
